(()=>{let n="cogitoChatbotConfig",a="cogitocore-chatbot-bubble-button",c="cogitocore-chatbot-bubble-window",p=window[n],h={open:`<svg id="openIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
